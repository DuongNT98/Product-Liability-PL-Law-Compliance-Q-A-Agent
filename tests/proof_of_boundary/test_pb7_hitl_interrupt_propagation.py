...
#
# Two test cases (framework Proof-of-Boundary PB-7):
#
...
#   Production-readiness criterion #12 — hitl_allowed guard
...
def test_pb7_hitl_interrupt_propagates() -> None:
    ...
    Covers framework Proof-of-Boundary PB-7 (first assertion):
...
def test_pb7_hitl_allowed_false_skips_interrupt() -> None:
    ...
    Covers framework HITL Compliance + criterion #12:
